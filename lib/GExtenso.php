...
*/
  public static function moeda(
    ...
    /*
     * Maison K. Sakamoto
     * Correcao, como a parte inteira divide por 100, a escrita perde o valor
     * entao estou multiplicando por 100 antes da divisao para corrigir o problema.
     */
    $valor = ($valor * 100);
...
*/
    $divisor = pow(10, $casasDecimais);
    
    $fracao = ($valor % $divisor);
