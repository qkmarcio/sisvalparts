...
include_once '../controller/cFornecedor.php';
...
function getListaFornecedor() {                                                   //FUNÇÃO PARA PEGAR O REMETENTE
    $obj = (object) $_REQUEST['obj'];                                         //RECEBE O OBJETO DO AJAX
    $col = new cFornecedor();                                                  //CHAMA A CONTROLLER
    $arrObj = $col->getAllFornecedor();                                        //BUSCA NA TAB_EXPORTADOR PELO NOME
